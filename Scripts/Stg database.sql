...
CREATE TABLE COUNTRIES_EXT 
    ( 
     ...
     COUNTRY_REGION_ID VARCHAR(40)  NOT NULL 
    ) 
;
...
CREATE TABLE PRODUCTS_EXT 
    ( 
     ...
     PROD_CATEGORY_ID VARCHAR(20)  NOT NULL , 
...
CREATE TABLE PROMOTIONS_EXT 
    ( 
     ...
     PROMO_BEGIN_DATE VARCHAR(20)  NOT NULL , 
     PROMO_END_DATE VARCHAR(20) NOT NULL 
    )
;
...
CREATE TABLE TIMES_EXT 
    ( 
     ...
     END_OF_CAL_MONTH VARCHAR(20)  NOT NULL , 
...
ALTER TABLE SALES_EXT 
    ADD CONSTRAINT SALES_CHANNEL_FK FOREIGN KEY 
    ( 
     CHANNEL_ID
    ) 
    REFERENCES CHANNELS_EXT
    ( 
     CHANNEL_ID
    ) 
